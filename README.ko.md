...
- 24시간에 1회만 (방해 최소화)
- 최소 5개 프롬프트 수집 후 제안 시작

## 설정

`~/.prompt-pattern/config.json` 파일로 설정을 변경할 수 있다:
...
| `minPromptsBeforeSuggest` | 5 | 제안 시작 최소 프롬프트 수 |
| `maxStoredPrompts` | 1000 | 최대 저장 프롬프트 수 |
...
- 이슈 리포트: [GitHub Issues](https://github.com/Gyeom/prompt-pattern/issues)
